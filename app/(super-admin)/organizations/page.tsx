...
export default function OrganizationsPage() {
  const { data: orgs, mutate: refetchOrgs, isLoading: loadingOrgs } = useSWR<OrgsRes>("/api/v1/organizations", apiFetch)
  const { data: branches, mutate: refetchBranches } = useSWR<BranchesRes>("/api/v1/branches", apiFetch)
