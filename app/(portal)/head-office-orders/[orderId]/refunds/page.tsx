  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-white/80">
              Process refunds with audit notes and keep credit holds in sync.
            </p>
          </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <Button variant="ghost" className="gap-2" onClick={() => router.push(numericId ? `/head-office-orders/${numericId}` : "/head-office-orders")}>
          <ArrowLeft className="h-4 w-4" />
          Back to order details
        </Button>
        <Button asChild variant="outline">
          <Link href="/head-office-orders">Orders list</Link>
        </Button>
      </div>
      ...
      {order && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="rounded-2xl border-0 bg-white p-4 shadow-md">
            ...
            <p className="text-xs text-muted-foreground">Refunds only available after fulfillment</p>
          </Card>
          <Card className="rounded-2xl border-0 bg-white p-4 shadow-md">
            <p className="text-sm text-muted-foreground">Refund flow</p>
            <p className="text-2xl font-semibold text-slate-900">Manual</p>
            <p className="text-xs text-muted-foreground">Log entries with internal notes</p>
          </Card>
          <Card className="rounded-2xl border-0 bg-white p-4 shadow-md">
              ...
              <Card className="p-6">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="rounded-2xl bg-slate-100 px-4 py-2 text-right">
                    ...
                    <p className="text-xl font-bold">{formatPKR(order.totalCents / 100)}</p>
                  </div>
                </div>
              </Card>
