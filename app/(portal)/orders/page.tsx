...
export default function OrdersPage() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader title="Orders" subtitle="View and manage orders by branch and status" actions={<Button onClick={() => mutate()} variant="outline">Refresh</Button>} />
      <Tabs tabs={[{ value: "all", label: "All" }, { value: "pending", label: "Pending" }, { value: "approved", label: "Approved" }, { value: "fulfilled", label: "Fulfilled" }]} onValueChange={(v) => setStatus(v === "all" ? "" : v.toUpperCase())} />
